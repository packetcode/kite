...
class InterfaceApp{
		...
		public function css()
		{
			$this->css = array('apps/interface/core/lib/font-awesome/css/font-awesome.min.css',
										'apps/interface/core/lib/bottle/bottle.css',
										'apps/interface/core/lib/css/interface.css');
		}

		public function js(){
			$this->js = array('apps/interface/core/lib/js/interface.js');
		}
